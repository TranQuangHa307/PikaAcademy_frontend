        ...
        <div>
          ...
          <form @submit.prevent="onSubmit">
            ...
            <div class="text-center">
              <p style="color: #feda6a;font-size: 15px;">Quên mật khẩu?</p>
            </div>
            <button type="submit" class="form_button">
              <span class="text_btn">Đăng nhập</span>
            </button>
          </form>
          <div class="text-center">
            <p class="text_p">Nếu bạn chưa có tài khoản? <router-link tag="span" class="text_span" :to="{ name: 'signUpUser' }">Đăng ký</router-link></p>
          </div>
        </div>
      </div>
    </div>
