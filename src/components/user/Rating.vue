...
<script>
import { addRating } from '../../api/rating.js'
export default {
  props: {
    courseId: {
      type: Number,
    ...
    async submitRating() {
      try {
        const data = {
          ...
          'user_purchase_course_id': this.userPurchaseCourseId
        }
