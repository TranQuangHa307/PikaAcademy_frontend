        ...
        <div class="card card_img" style="color: white; border: 0" :style="{ backgroundImage: 'url(' + course.url_image + ')' }">
          ...
          <div class="card-footer mt-2 footer_card">
            ...
            <div v-else style="width: 100%; display: flex; height: 50px;">
              <div v-else class="pt-1" style="flex: 1 1 auto; display: flex;align-items: center;"><p class="text_price mb-0">Miễn phí</p></div>
              <div style="align-items: center; display: flex;">
                <router-link v-if="course.price===0" tag="button" :to="{ name: 'course', params: { id: course.id }}" class="btn btn-outline-info" style="width: 80px; border-radius: 50rem !important">Bắt đầu</router-link>
